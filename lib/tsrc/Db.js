    ...
    describe('#Db.open, #Db.close', ()=>{
        ...
        it('Setup', ()=>{
            const databases = {
                ...
                db2 : {
                    schema: 'postgres',
                    user: api.db.postgres.helpers.masterDbProps.user,
                    host: api.db.postgres.helpers.masterDbProps.host,
                    database: api.db.postgres.helpers.masterDbProps.database,
                    password: api.db.postgres.helpers.masterDbProps.password,
                    port: api.db.postgres.helpers.masterDbProps.port
                }
            };
