...
const DB_TABLE = './mysql.innodb.no.indexses.template';

require('./perormance')('perormance_mysql_innodb_no_indexses_pool_16_1000', api, dbHelpers, api.db.mysql.Pool, cridentials, DB_TABLE);
