...
const DB_TABLE = './sql.s.sessions.innodb.no.indexses.template';

require('./perormance')('mysql_innodb_no_indexses_64_1000', api, dbHelpers, api.db.mysql.Pool, cridentials, DB_TABLE);
